...
export default function MentorPage() {
  ...
  // ⭐️ HÀM ĐỌC TEXT BẰNG GOOGLE TRANSLATE TTS ⭐️
  const speakText = async (text, onEnd) => {
    ...
    try {
      ...
      const response = await api.post('/mentor/tts/synthesize', {
        text,
        options: {
          language: 'vi',
          gender: ttsConfig.gender,
                ...
                <div className="bg-white rounded-xl shadow-lg p-6">
                  <div className="flex items-center justify-between mb-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <h3 className="font-bold text-lg text-gray-800">Cấu hình giọng đọc</h3>
                        <p className="text-xs text-gray-500">Chọn giọng nam/nữ và điều chỉnh thông số</p>
                      </div>
                    </div>
                    <button
                    ...
                    <div className="space-y-4 pt-4 border-t border-gray-200">
                      ...
                      <div>
                        ...
                        <select
                          ...
                          onChange={(e) => setTtsConfig({ ...ttsConfig, gender: e.target.value })}
                      ...
                      <button
                        ...
                        className="w-full px-4 py-2 bg-gradient-to-r from-purple-500 to-purple-600 text-white rounded-lg font-semibold hover:from-purple-600 hover:to-purple-700 transition"
                      >
                        💾 Lưu cấu hình
                      </button>
                    </div>
                  ...
                  <div className="border border-gray-200 rounded-lg p-4 bg-gradient-to-b from-gray-50 to-white max-h-[300px] overflow-y-auto">
                    ...
                    <div className="space-y-4">
                      {lecture.sections.map((section, idx) => (
                        <div
                          key={idx}
                          className={`p-4 rounded-lg transition-all ${idx === currentSectionIndex
