      ...
      <div className="flex items-center gap-2 pb-3 border-b border-gray-200">
        <div className="w-10 h-10 rounded-full bg-linear-to-br from-red-500 to-red-600 flex items-center justify-center">
          <svg
            ...
            viewBox="0 0 640 512"
            className="h-6 w-6 text-white" // Tailwind màu trắng & kích thước
            fill="currentColor" // ⭐️ để màu Tailwind tác dụng
          >
                ...
                <div className="flex items-center gap-3 mb-4">
                  <div className="w-10 h-10 rounded-lg bg-linear-to-br from-red-500 to-red-600 flex items-center justify-center">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 448 512"
                      className="h-6 w-6 text-white" // Tailwind color & size
                      fill="currentColor" // ⭐️ quan trọng để màu Tailwind tác dụng
                    >
                    ...
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 rounded-lg bg-linear-to-br from-purple-500 to-purple-600 flex items-center justify-center">
                        <svg
                          ...
                          viewBox="0 0 640 640"
                          fill="currentColor"
                          className="h-6 w-6 text-white" // giống style text-white text-lg
                        >
                  ...
                  <div className="flex items-center gap-3 mb-4">
                    <div className="w-10 h-10 rounded-lg bg-linear-to-br from-green-500 to-green-600 flex items-center justify-center">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 640 640"
                        className="h-6 w-6 text-white" // bạn có thể tùy chỉnh size và màu
                        fill="currentColor"
                      >
