    ...
    <div className="min-h-screen bg-[#fff7f0] relative overflow-x-hidden flex flex-col">
      ...
      <main className="grow max-w-3xl mx-auto p-4 text-center relative z-10 w-full">
        ...
        <h1 className="text-4xl font-extrabold mb-4 text-blue-700">
          Chủ đề: <span className="text-red-700">{title}</span>
        </h1>
        ...
        >
          ...
          >
            <p className="text-4xl md:text-5xl font-black text-red-800 p-4">
              {currentItem.front}
            </p>
          ...
          >
            <div className={`${isFlipped ? "rotate-y-180" : ""} w-full`}>
              <p className="text-3xl md:text-4xl font-bold text-gray-700 mb-2">
                {currentItem.back}
              </p>
              {currentItem.example && (
                <p className="text-lg italic text-red-600 px-4 mt-4">
                  "{currentItem.example}"
                </p>
              )}
            </div>
