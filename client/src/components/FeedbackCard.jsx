...
const FeedbackCard = ({ quote, name, role, bgColor }) => (
    ...
    >
        ...
        {/* Author Info */}
        <div className="relative z-10 flex items-center mt-auto pt-6 border-t border-gray-100 dark:border-gray-700">
            ...
            {/* Name + Role */}
            <div>
                <p className="font-bold text-gray-800 dark:text-gray-100 text-left group-hover:text-red-600 dark:group-hover:text-red-400 transition-colors duration-300">
                    {name}
                </p>
