...
import ParticipantAvatar from './ParticipantAvatar'; // Assuming we have this, or we reuse the avatar logic
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  {/* Avatar Container */}
                  <div className={`rounded-2xl border-4 shadow-xl overflow-hidden bg-white/10 backdrop-blur-sm mb-2 flex items-end justify-center ${
                    rank === 1 ? 'border-yellow-300 w-24 h-32' : rank === 2 ? 'border-gray-300 w-20 h-28' : 'border-orange-300 w-20 h-28'
                  }`}>
