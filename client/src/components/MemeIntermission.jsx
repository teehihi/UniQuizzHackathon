...
const MEME_COLLECTION = [
  // Hype / Cheers
  { type: 'hype', text: "Đỉnh của chóp! 🔥", image: "https://media.giphy.com/media/3o7abKhOpu0NvenUhW/giphy.gif" }, // Minions
  { type: 'hype', text: "Cháy quá anh em ơi! 🚀", image: "https://media.giphy.com/media/ne3xrYlWtQFtC/giphy.gif" }, // Minions cheer
  { type: 'dance', text: "Quẩy lên nào! 💃", image: "https://media.giphy.com/media/fwHR8rLRfv3wo/giphy.gif" }, // Carlton
  { type: 'cool', text: "Dễ như ăn kẹo! 😎", image: "https://media.giphy.com/media/XreQmk7ETCZrG/giphy.gif" }, // Cool kid glasses
  ...
  { type: 'thinking', text: "Đang phân tích... 🤔", image: "https://media.giphy.com/media/3o7buirYcmV5nSwIR2/giphy.gif" }, // Confused math
  ...
  { type: 'shock', text: "Không thể tin được! 😲", image: "https://media.giphy.com/media/tfUW8mhiFk8NlJghwv/giphy.gif" }, // Cat shock
  ...
  { type: 'funny', text: "Bình tĩnh tự tin! �", image: "https://media.giphy.com/media/1xVbRS6j52YSzp9E7Q/giphy.gif" }, // You got this
  { type: 'funny', text: "Nhanh tay lên! ⏰", image: "https://media.giphy.com/media/Q81NcsY6YxK7jxnr4v/giphy.gif" }, // Running
  { type: 'funny', text: "Chúc may mắn! 🍀", image: "https://media.giphy.com/media/9wLKh6ms5tTkfpqCyu/giphy.gif" }, // Good luck
];
