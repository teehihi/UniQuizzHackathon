      ...
      <div className="bg-[#1a1a1a] rounded-3xl border-4 border-[#fbbf24] shadow-[0_0_50px_rgba(251,191,36,0.3)] overflow-hidden relative">
        ...
        <div className="flex flex-col md:flex-row items-stretch p-2 md:p-0">
          ...
          <div className="flex-[2] flex flex-col border-b-2 md:border-b-0 md:border-r-2 border-dashed border-gray-600 bg-[#262626]">
             ...
             {/* Row 1: Join URL */}
             <div className="flex-1 p-6 border-b border-gray-700 flex flex-col justify-center">
                ...
                <div className="bg-black rounded-lg p-3 flex items-center justify-between group cursor-pointer hover:bg-gray-900 transition-colors border border-gray-800"
                     onClick={() => copyToClipboard(joinUrl, 'link')}>
                    <span className="text-xl md:text-2xl font-bold text-white font-mono tracking-wide truncate mr-2">
                        {displayUrl}
                    </span>
             ...
             <div className="flex-1 p-6 flex flex-col justify-center">
                ...
                <div className="bg-black rounded-lg p-3 flex items-center justify-between group cursor-pointer hover:bg-gray-900 transition-colors border border-gray-800"
                    ...
                    <span className="text-4xl md:text-5xl font-bold text-[#fbbf24] font-mono tracking-[0.2em]">
                        {roomCode}
                    </span>
          ...
          <div 
             className="flex-1 bg-white p-6 flex flex-col items-center justify-center cursor-pointer hover:bg-gray-50 transition-colors group relative min-w-[200px]"
